...
HEX_TO_DECIMAL:
//The hex number is stored in accumulator
// The resultant decimal is stored in r5 r6 r7
mov b, #10
div ab
mov r7, b //lower number
mov b,#10
div ab
mov r6, b
mov r5, a
ret
//-------------- END OF Hex to decimal FUNCTION ----------------------
...
start:
	...
	;sjmp here1
	  ...
	  mov R4, #30H // Tracks the number of times timer0 has overflown
	  mov R5, #30H
	  mov R6, #30H
	  mov R7, #30H
	  ...
	  mov   dptr,#my_string5 //my_string4 = "ms"
	  acall lcd_sendstring
